...
exports.postImage = exports.login = exports.getMessages = exports.createMessage = exports.getDogMatchesArray = exports.putAndCheckMatch = exports.getDogsByUserId = exports.getAllDogs = exports.createDog = exports.createUser = exports.getUser = void 0;
...
function postImage(id) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const dog = yield Dog.findByPk(id);
            return dog;
        }
        catch (error) {
            console.log(error);
